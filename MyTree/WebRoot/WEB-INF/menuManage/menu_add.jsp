...
<html>
	...
	<body>
	<div>当前位置：菜单管理 > <font color="#ff6600">新增</font></div>
		<form action="menu_save.action" method="post" name="addform" id="addForm">
		<input type="hidden" name="menuId" value="${menuId }">
			<table width="97%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td colspan="3">
						<label>
							<textarea name="menuRemark" id="menuRemark" style="width: 70%; height: 60px;"></textarea>
						</label>
					</td>
				</tr>
			</table>
